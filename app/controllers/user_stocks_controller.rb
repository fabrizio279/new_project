...
def create
  if params[:stock_id].present?
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: 'User stock was successfully added' }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'This stock was successfully removed from your portfolio' }
